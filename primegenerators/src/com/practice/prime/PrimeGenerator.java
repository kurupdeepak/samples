...
//				System.out.println(this.getName() + " Notified controller");
			}/*else {
				try {
					Thread.sleep(100);
	...
	public String toString() {
		return "PrimeGenerator [pollTime=" + pollTime + ", start=" + start + ", end=" + end + ", primesFound="
				+ primesFound + ", id=" + id + ", currentState=" + currentState + ", complete=" + complete
				+ ", controller=" + controller + "]";
	}*/
	
	@Override
	public String toString() {
		return "PrimeGenerator [id =" + generatorId + ", start=" + fromNumber + ", end=" + toNumber +"," + currentState + "," + primesFound + "]";
	}
